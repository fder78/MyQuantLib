...
void registerRatehelpers(const XLOPER &xDll) {
        ...
        Excel(xlfRegister, 0, 25, &xDll,
            ...
            // parameter codes
            TempStrNoSize("\x11""CCPPCCCCCCPCPPPL#"),
            // function display name
            TempStrNoSize("\x11""qlSwapRateHelper2"),
            // comma-delimited list of parameter names
            TempStrNoSize("\xA9""ObjectId,Rate,SettlDays,Tenor,Calendar,FixedLegFrequency,FixedLegConvention,FixedLegDayCounter,IborIndex,Spread,ForwardStart,DiscountingCurve,Permanent,Trigger,Overwrite"),
            // function type (0 = hidden, 1 = worksheet)
            TempStrNoSize("\x01""1"),
            // function category
            TempStrNoSize("\x14""QuantLib - Financial"),
