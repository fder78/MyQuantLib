...
namespace QuantLib {
	...
	AutocallFdm2dBlackScholesOp::AutocallFdm2dBlackScholesOp(
	...
	Size AutocallFdm2dBlackScholesOp::size() const {
		return 2;
	}

	void AutocallFdm2dBlackScholesOp::setTime(Time t1, Time t2) {
		opX_.setTime(t1, t2);
		opY_.setTime(t1, t2);
	...
	Disposable<Array> AutocallFdm2dBlackScholesOp::solve_splitting(Size direction,
	...
	Disposable<Array> AutocallFdm2dBlackScholesOp::preconditioner(const Array& r, Real dt) const {
		return solve_splitting(0, r, dt);
	}

#if !defined(QL_NO_UBLAS_SUPPORT)
	Disposable<std::vector<SparseMatrix> >
		AutocallFdm2dBlackScholesOp::toMatrixDecomp() const {
